...
<div class="col">
<h3 class="page-title">Check Sales Report Perday</h3>
<ul class="breadcrumb">
...
if (isset($_POST['check'])) {
	...
	$co=$we["id"];
	$sql =$con->query("SELECT id,product_name,quantity,pprice,ttprice,date,sum(ttprice) as total FROM sale WHERE `date` BETWEEN '$a' AND '$b' ")or die(mysqli_error());
$sum = 0;
$n=1;
...
while ($row=mysqli_fetch_array($sql)) {
	...
	<td><?php echo $row['ttprice']."&nbsp;&nbsp;&nbsp;rwf"; ?></td>	
	<td><?php echo $a."&nbsp;&nbsp;"." to"."&nbsp;&nbsp;".$b; ?></td>
</tr>
