...
<a href="add-purchase.php" class="btn btn-success"><i class="fas fa-plus"></i></a>
</div>
</div>
</div>
<div class="row">
...
$ch=$con->query($ss);
	...
	$co=$we["id"];
$sel=$con->query("SELECT * from purchase  INNER JOIN customer ON customer.id   WHERE   customer.id=purchase.id")or die(mysqli_error());
...
<a href="edit-purchase.php?pur_id=<?php echo $row['pur_id']; ?>" class="btn btn-sm bg-warning-light mr-2">
